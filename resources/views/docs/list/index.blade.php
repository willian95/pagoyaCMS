            ...
            <div class="card card-custom">
                ...
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    <div class="card-title">
                        <h3 class="card-label">Documentación
                    </div>
                    <div class="card-toolbar">
                        <!--begin::Button-->
                        <a href="{{ route('docs.create') }}" class="btn btn-primary font-weight-bolder">
                            ...
                            <tbody>
                                <tr v-for="doc in docs">
                                    ...
                                    <td>
                                        ...
                                        <button class="btn btn-secondary" @click="erase(doc.id)"><i class="far fa-trash-alt"></i></button>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
